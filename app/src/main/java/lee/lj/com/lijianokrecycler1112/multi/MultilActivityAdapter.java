...
public class MultilActivityAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == 0) {
            View view1 = LayoutInflater.from(context).inflate(R.layout.activity_item1, parent, false);
            return new ViewHolder1(view1);
        } else if (viewType == 1) {
            View view2 = LayoutInflater.from(context).inflate(R.layout.activity_item2, parent, false);
    ...
    static class ViewHolder3  extends RecyclerView.ViewHolder{
        ...
        @BindView(R.id.item3_img1)
        ImageView listItem3Imageview1;
        @BindView(R.id.item3_img2)
        ImageView listItem3Imageview2;
        @BindView(R.id.item3_img3)
